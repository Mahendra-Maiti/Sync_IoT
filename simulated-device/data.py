...
HOST='10.0.0.18'
PORT=8081
CONTROLLER_ADDR='https://2e71513c.ngrok.io/get_edge_address'
...
'Baltimore.txt', 'Dorchester.txt', 'Garrett.txt', 'Howard.txt', "Prince George's.txt", 'Essex.txt', 'Hampden.txt', 'Suffolk.txt',
...
PROTOCOL_NAME = IoTHubTransportProvider.MQTT


DEVICE_NAMES=["DEVICE_JEFFERSON","DEVICE_HENNEPIN","DEVICE_ANOKA","DEVICE_RAMSEY","DEVICE_MINNEHAHA"]

DEVICE_TO_FILE_MAP={"DEVICE_JEFFERSON": "Jefferson.txt", "DEVICE_HENNEPIN": "Hennepin.txt", "DEVICE_ANOKA": "Anoka.txt",
                     "DEVICE_RAMSEY": "Ramsey.txt", "DEVICE_MINNEHAHA": "Minnehaha.txt"}
